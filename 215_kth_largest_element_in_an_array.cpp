// Illegally sorting With time complexity of O(nlogn) and space complexity of O(1)
class Solution {
public:
...
// Heap data structure with time complexity of O(nlogn) and space complexity of O(1)
class Solution {
public:
    int findKthLargest(vector<int>& nums, int k) {
